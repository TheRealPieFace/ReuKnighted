...
namespace TPCEngine
{
    public class TPCamera : MonoBehaviour
    {
        ...
        private void CameraMovement()
        {
            ...
            //****************************************PIERRES EDIT*************************************************//
            // I removed the X axis so that it won't follow the character along the X, but I think a better solution would be to clamp it so that it only follows so far
            // Also I don't want it to follow the Y axis all the time only when it gets a certain distance away. 
            // targetPos is the character position
            // cPos is the camera position
            // TODO: allow targetPos to pull currentTarget.position.x however clamp it to keep it from going too far left or right, then allow buffer in the y axis before following.
            //******************************************************************************************************//
        ...
        protected virtual void ScrollingCameraDistance()
        {
            ...
            float mouseWheelAxis = TPCInput.GetAxis("Mouse ScrollWheel") * scrollSensitivity;
